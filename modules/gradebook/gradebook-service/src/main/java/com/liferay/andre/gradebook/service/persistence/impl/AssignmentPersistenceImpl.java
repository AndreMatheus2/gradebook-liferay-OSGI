...
package com.liferay.andre.gradebook.service.persistence.impl;
...
import com.liferay.andre.gradebook.model.AssignmentTable;
import com.liferay.andre.gradebook.model.impl.AssignmentImpl;
import com.liferay.andre.gradebook.model.impl.AssignmentModelImpl;
import com.liferay.andre.gradebook.service.persistence.AssignmentPersistence;
import com.liferay.andre.gradebook.service.persistence.AssignmentUtil;
import com.liferay.andre.gradebook.service.persistence.impl.constants.GradebookPersistenceConstants;
...
public class AssignmentPersistenceImpl
	...
	public Assignment[] findByGroupId_PrevAndNext(
		...
		Assignment assignment = findByPrimaryKey(assignment);
	 ...
	 */
	@Override
	public Assignment create(long assignment) {
		Assignment assignment = new AssignmentImpl();

		assignment.setNew(true);
		assignment.setPrimaryKey(assignment);
	 ...
	 */
	@Override
	public Assignment remove(long assignment) throws NoSuchAssignmentException {
		return remove((Serializable)assignment);
	}
	 ...
	 */
	@Override
	public Assignment findByPrimaryKey(long assignment)
		throws NoSuchAssignmentException {

		return findByPrimaryKey((Serializable)assignment);
	}
	 ...
	 */
	@Override
	public Assignment fetchByPrimaryKey(long assignment) {
		return fetchByPrimaryKey((Serializable)assignment);
	}
