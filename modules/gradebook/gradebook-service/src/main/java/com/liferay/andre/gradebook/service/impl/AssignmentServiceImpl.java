...
import com.liferay.andre.gradebook.service.base.AssignmentServiceBaseImpl;
...
@Component(
		property = {
				"json.web.service.context.name=gradebook","json.web.service.context.path=Assignment"
		},
...
public class AssignmentServiceImpl extends AssignmentServiceBaseImpl {
	...
	public Assignment getAssignment(long assignmentId)
			throws PortalException {Assignment assignment =
			assignmentLocalService.getAssignment(assignmentId);
		return assignment;
	}
