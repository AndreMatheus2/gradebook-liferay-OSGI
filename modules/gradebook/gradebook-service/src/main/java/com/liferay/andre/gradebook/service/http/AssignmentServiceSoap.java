...
package com.liferay.andre.gradebook.service.http;

import com.liferay.andre.gradebook.service.AssignmentServiceUtil;
 ...
 * <code>com.liferay.andre.gradebook.model.AssignmentSoap</code>. If the method in the
 * service utility returns a
 * <code>com.liferay.andre.gradebook.model.Assignment</code>, that is translated to a
 * <code>com.liferay.andre.gradebook.model.AssignmentSoap</code>. Methods that SOAP
...
public class AssignmentServiceSoap {
	...
	public static com.liferay.andre.gradebook.model.AssignmentSoap
			addAssignment(
		...
		try {
			...
			com.liferay.andre.gradebook.model.Assignment returnValue =
				AssignmentServiceUtil.addAssignment(
					groupId, titleMap, descriptionMap, dueDate, serviceContext);

			return com.liferay.andre.gradebook.model.AssignmentSoap.toSoapModel(
				returnValue);
		}
	...
	public static com.liferay.andre.gradebook.model.AssignmentSoap[]
		...
		try {
			java.util.List<com.liferay.andre.gradebook.model.Assignment>
				returnValue = AssignmentServiceUtil.getAssignmentsByGroupId(
					groupId);

			return com.liferay.andre.gradebook.model.AssignmentSoap.
