package com.liferay.andre.gradebook.web.asset.model;

import com.liferay.asset.display.page.portlet.AssetDisplayPageFriendlyURLProvider;
import com.liferay.asset.kernel.model.AssetRenderer;import com.liferay.asset.kernel.model.AssetRendererFactory;
...
public class AssignmentAssetRendererFactory
    ...
    public AssetRenderer<Assignment> getAssetRenderer(long classPK, int type)
        ...
        assignmentAssetRenderer.setAssetRendererType(type);assignmentAssetRenderer.setServletContext(_servletContext);
    ...
    public PortletURL getURLView(
        ...
        LiferayPortletURL liferayPortletURL =
                liferayPortletResponse.createLiferayPortletURL(
                        GradebookPortletKeys.GRADEBOOK, PortletRequest.RENDER_PHASE);try {
    ...
    private AssetDisplayPageFriendlyURLProvider
            _assetDisplayPageFriendlyURLProvider;@Reference
