package com.liferay.andre.gradebook.web.display.context;
...
import com.liferay.portal.kernel.util.ParamUtil;import com.liferay.portal.kernel.util.Validator;
...
public class AssignmentsManagementToolbarDisplayContext
    ...
    public AssignmentsManagementToolbarDisplayContext(
        ...
        _portalPreferences = PortletPreferencesFactoryUtil.getPortalPreferences(
                liferayPortletRequest);_themeDisplay = (ThemeDisplay)httpServletRequest.getAttribute(
...
// Create the menu.
    ...
    @Override
    public String getClearResultsURL() {return getSearchActionURL();
    }
    /**
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setProperty(
                "mvcRenderCommandName", MVCCommandNames.VIEW_ASSIGNMENTS);String navigation = ParamUtil.getString(
    ...
    public List<ViewTypeItem> getViewTypeItems() {
        ...
        String orderByCol =
                ParamUtil.getString(request, "orderByCol", "title");String orderByType =
     ...
     */
    private PortletURL _getCurrentSortingURL() throws PortletException {PortletURL sortingURL = PortletURLUtil.clone(
