<%@ include file="init.jsp"%><div class="container-fluid-1280">
...
<liferay-ui:success key="assignmentUpdated" message="assignment-updated-successful
<liferay-ui:success key="assignmentDeleted" message="assignment-deleted-successful
...
</liferay-ui:search-container-row><%-- Iterator / Paging --%>
<liferay-ui:search-iterator
displayStyle="${assignmentsManagementToolbarDisplayContext.getDisplaySt
markupView="lexicon"
/>
</liferay-ui:search-container>
</div>